...
const char chip8_default_characterset[] = {
...
void chip8_init(struct chip8* chip8)
{
    ...
    memcpy(&chip8->memory.memory, chip8_default_characterset, sizeof(chip8_default_characterset));
}
...
static void chip8_exec_extended_F(struct chip8* chip8,unsigned short opcode)
{
    ...
    {   
        ...
        case 0x33:
            ...
            unsigned char tens = chip8->registers.V[x]/ 10 % 100;
